...
// Aliases do modo inline do @sigil/test (tests/inline-host.test.ts): o wire TS
// é importado direto (sem bundle), então "vscode" resolve para o mock
// compartilhado e "@sigil/core" para o SRC (o dist faria require("vscode")
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@sigil/core": path.resolve(process.cwd(), "packages/core/src/index.ts"),
    },
  },
  test: {
